...
<div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-display-middle">
    ...
    <form action="atualizarAction.php" class="w3-container" method='post'>
        ...
        <input name="txtsobrenome" class="w3-input w3-light-grey w3-border" value="<?php echo $_GET['sobrenome']?>">
        <br>
        ...
        <input name="txtcargo" class="w3-input w3-light-grey w3-border" value="<?php echo $_GET['cargo']?>">
        <br>
